package cafe.nhnnext.org.babydear.adapter;
...
public class RVAdapter extends RecyclerView.Adapter<RVAdapter.viewHolder>{
    ...
    private List<CardGeneralModel> cards;
    private Context context;
    private boolean open = true;
    private Typeface typeface;


    public RVAdapter(List<CardGeneralModel> cards, Context context){
        this.cards = cards;
    ...
    public viewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_card_general, parent, false);
    ...
    public void onBindViewHolder(final viewHolder holder, int position) {
        ...
        holder.date.setText(cards.get(position).date);
        holder.photo.setImageResource(cards.get(position).img);
        holder.diary_text.setText(cards.get(position).text);
